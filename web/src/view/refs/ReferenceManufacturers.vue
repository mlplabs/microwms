<template>
  ...
  <simple-table :is-show-paging="true" :columns="columns" :rows="tableData" ></simple-table>
</template>
...
import SimpleTable from "@/components/InlineTable";

export default {
  name: "ReferenceManufacturers",
  components: {SimpleTable, AutocompleteInput, PaginationBar},
